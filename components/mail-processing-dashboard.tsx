...
export function MailProcessingDashboard() {
  const { activeStep, setActiveStep, isProcessing, isClearingData, isExporting, isBulkDeleting } = useWorkflowStore()
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      <WorkflowNavigation activeStep={activeStep} onStepChange={setActiveStep} isProcessing={isProcessing} isClearingData={isClearingData} isExporting={isExporting} isBulkDeleting={isBulkDeleting} />
