...
export function WorkflowNavigation({ activeStep, onStepChange }: WorkflowNavigationProps) {
  ...
  const steps = [
    ...
    { id: "assign-customers", label: "Team Assignment", icon: UserCheck, tooltip: "Configure automated rules for cargo processing and team assignment" },
  ...
  return (
    <TooltipProvider>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed left-0 top-0 h-full bg-white border-r border-gray-100 z-40 transition-transform duration-300 ease-in-out
