-- Insert Emirates Load Plan Sample Data - EK0205 (Updated)
-- This script inserts updated sample data for EK0205 flight on 12Oct 2025
...
-- Success message
SELECT 'Emirates Load Plan EK0205 (Updated) sample data inserted successfully!' as message;
