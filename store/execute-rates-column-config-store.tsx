...
// Function to create default column configurations for ExecuteRates
...
export const useExecuteRatesColumnConfigStore = create<ColumnConfigState>()(
  persist(
    (set, get) => ({
    ...
    {
      name: 'execute-rates-column-configs',
