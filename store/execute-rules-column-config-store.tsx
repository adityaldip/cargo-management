...
// Function to create default column configurations for ExecuteRules
...
export const useExecuteRulesColumnConfigStore = create<ColumnConfigState>()(
  persist(
    (set, get) => ({
    ...
    {
      name: 'execute-rules-column-configs-v4', // Changed name to force reset
